...
import { OutlineCallIcon, OutlineDrpopdown, OutlineMail, OutlineMessageIcon, OutlineUserIcon, WhatsAppIcon } from "@/icons/icons";
        ...
        >
            ...
            {formData.map((data, index) => (
                <div key={index} className="flex flex-col gap-1">
                    <div className="flex  gap-2 text-gray-primary rounded-lg p-3 bg-white box_shadow2">
                        <label
                            htmlFor={data.name}
